...
export const loginUsuario = async (req, res) => {
    ...
    const token = jwt.sign({ idUsuario: usuarioLogueado._id, nombre: usuarioLogueado.nombre, correo: usuarioLogueado.correo },
...
export const registerUsuario = async (req, res) => {
    ...
    const TOKEN = jwt.sign({ idUsuario: usuarioCreado._id, nombre: usuarioCreado.nombre, correo: usuarioCreado.correo }, process.env.SECRET_JWT, { expiresIn: "1h" });
